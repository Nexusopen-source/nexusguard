    ...
    <main className="mx-auto max-w-7xl px-4 pb-16 pt-8 md:px-8 md:pt-10">
        ...
        <div className="relative grid gap-8 xl:grid-cols-2">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--muted)/0.25)] p-2 pr-4">
              <Image src="/nexusguard-logo.jpeg" alt="NexusGuard logo" width={56} height={56} className="h-14 w-14 rounded-xl" priority />
              <div>
                <p className="text-[11px] uppercase tracking-[0.28em] text-cyan-300">NexusGuard</p>
            ...
            <p className="max-w-2xl text-base text-[hsl(var(--muted-foreground))] md:text-lg">
              NexusGuard sits between agent intent and economic execution, enforces policy and risk controls, and permits only wallet-native signed transaction flow with full audit evidence.
            </p>
      ...
      <section className="section-divider mt-14 pt-12">
        <div className="mb-7 max-w-3xl space-y-3">
          ...
          <p className="text-[hsl(var(--muted-foreground))]">
            Autonomous systems now trigger real economic outcomes. Without hard controls, model errors become financial errors. NexusGuard introduces policy, risk scoring, operator approvals, and immutable decision evidence before transaction submission.
          </p>
        </div>
      </section>
      ...
      <section className="section-divider mt-10 pt-12">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            "NexusGuard evaluates policy and risk",
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          <Card className="lg:col-span-3 premium-panel">
            ...
            <CardContent className="grid gap-3 text-sm text-[hsl(var(--muted-foreground))] md:grid-cols-2">
              ...
              <div className="rounded-xl border border-[hsl(var(--border))] p-3">
                <p className="mb-1 text-xs uppercase tracking-[0.18em] text-cyan-200">NexusGuard Control Plane</p>
      ...
      <section className="section-divider mt-10 pt-12">
        <Card className="premium-panel overflow-hidden border-cyan-300/20 bg-[linear-gradient(180deg,rgba(13,26,49,0.9),rgba(8,14,26,0.86))]">
          <CardHeader>
            <CardTitle className="text-3xl md:text-4xl">NexusGuard makes autonomous finance governable.</CardTitle>
      ...
      <footer className="mt-12 border-t border-[hsl(var(--border))] pt-6 text-sm text-[hsl(var(--muted-foreground))]">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <p className="inline-flex items-center gap-2"><CircuitBoard className="h-4 w-4" /> NexusGuard · Policy-Controlled Payment Firewall</p>
