...
const decisionCards = [
  ...
  },
  {
    ...
    text: "Action is allowed with elevated caution signals. NexusGuard records rationale and findings.",
  },
  {
    ...
    <main className="mx-auto max-w-7xl px-4 pb-16 pt-8 md:px-8 md:pt-12">
        ...
        <div className="relative grid gap-8 lg:grid-cols-2 lg:items-end">
          <div className="space-y-5">
            ...
            <p className="max-w-xl text-base text-[hsl(var(--muted-foreground))] md:text-lg">
              NexusGuard sits between agent intent and economic execution, scoring risk, enforcing policy, and allowing only wallet-signed XDR flow with full audit evidence.
            </p>
          ...
          <Card className="border-cyan-300/20 bg-[linear-gradient(180deg,rgba(17,28,52,0.8),rgba(10,16,33,0.8))]">
            ...
            <CardContent className="space-y-2 text-sm text-[hsl(var(--muted-foreground))]">
              ...
              <div className="flex items-center justify-between rounded-lg border border-[hsl(var(--border))] px-3 py-2">
                <span>NexusGuard policy + risk evaluation</span>
      ...
      <section className="section-divider mt-14 pt-12">
        <div className="mb-6 max-w-3xl space-y-3">
          ...
          <p className="text-[hsl(var(--muted-foreground))]">
            Agentic systems can trigger real economic actions at machine speed. NexusGuard inserts strict policy checks, risk scoring, human-approval gates, and auditability before money movement.
          </p>
        </div>
      </section>
      ...
      <section className="section-divider mt-10 pt-12" id="trust-architecture">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            "NexusGuard evaluates policy + risk",
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <Card className="lg:col-span-3">
            <CardHeader>
              ...
              <CardTitle className="text-2xl">Browser/Wallet/NexusGuard/Stellar boundaries are explicit.</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-[hsl(var(--muted-foreground))]">
              <div className="rounded-xl border border-[hsl(var(--border))] p-3">
                Browser + Agent UI sends action proposal to NexusGuard API boundary.
              </div>
              <div className="rounded-xl border border-[hsl(var(--border))] p-3">
                NexusGuard evaluates policy and risk; returns APPROVE/WARN/REQUIRE_APPROVAL/BLOCK with evidence.
              </div>
      ...
      <section className="section-divider mt-10 pt-12">
        <Card className="overflow-hidden border-cyan-300/25 bg-[linear-gradient(180deg,rgba(16,30,55,0.8),rgba(8,14,28,0.8))]">
          <CardHeader>
            <CardTitle className="text-3xl">NexusGuard is the safety layer for autonomous economic action.</CardTitle>
      ...
      <footer className="mt-12 border-t border-[hsl(var(--border))] pt-6 text-sm text-[hsl(var(--muted-foreground))]">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <p>NexusGuard · Policy-Controlled Payment Firewall on Stellar</p>
