...
export default function LoginPage() {
  return (
    <main className="mx-auto grid min-h-screen max-w-7xl items-center gap-6 px-4 py-12 md:grid-cols-2 md:px-8">
      <section className="space-y-5">
        ...
        <p className="max-w-lg text-[hsl(var(--muted-foreground))]">
          NexusGuard binds session identity to wallet context. No server-side private-key custody. Signed transaction flow remains wallet-native.
        </p>
