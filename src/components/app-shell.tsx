...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="nexusguard-shell mx-auto min-h-screen max-w-7xl px-4 pb-12 pt-6 md:px-8">
      <header className="glass-panel mb-8 overflow-hidden rounded-2xl p-5 md:p-6">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            <p className="text-xs uppercase tracking-[0.35em] text-cyan-300/90">NexusGuard Mission Control</p>
