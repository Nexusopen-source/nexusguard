...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="nexusguard-shell mx-auto min-h-screen max-w-7xl px-3 pb-10 pt-4 md:px-6">
        ...
        <aside className="hidden w-70 border-r border-[hsl(var(--border))] bg-[linear-gradient(180deg,rgba(10,17,30,0.95),rgba(7,12,22,0.95))] p-5 lg:flex lg:flex-col">
          <div className="mb-8">
            <div className="mb-3 inline-flex items-center gap-3">
              <Image src="/nexusguard-logo.jpeg" alt="NexusGuard logo" width={52} height={52} className="h-13 w-13 rounded-xl" priority />
              <div>
                <p className="text-[11px] uppercase tracking-[0.35em] text-cyan-300">NexusGuard</p>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="inline-flex items-center gap-3">
                  <Image src="/nexusguard-logo.jpeg" alt="NexusGuard logo" width={40} height={40} className="h-10 w-10 rounded-lg" priority />
                  <div>
