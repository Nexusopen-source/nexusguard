        ...
        <aside className="hidden w-70 border-r border-[hsl(var(--border))] bg-[linear-gradient(180deg,rgba(10,17,30,0.95),rgba(7,12,22,0.95))] p-5 lg:flex lg:flex-col">
          <div className="mb-8">
            <div className="mb-3 inline-flex items-center gap-3">
              <Image src="/nexusguard-logo.svg" alt="NexusGuard logo" width={52} height={52} className="h-13 w-13" priority />
              <div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="inline-flex items-center gap-3">
                  <Image src="/nexusguard-logo.svg" alt="NexusGuard logo" width={40} height={40} className="h-10 w-10" priority />
                  <div>
