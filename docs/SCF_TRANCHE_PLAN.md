...
This document outlines the funding tranches and key deliverables for NexusGuard, structured around the Stellar Community Fund (SCF) Build-style framework. The deliverables are derived directly from the existing code structure, tests, database migrations, and observability tools implemented in this repository.
...
* **Repository Artifact**: [src/lib/policy/engine.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/policy/engine.ts)
* **Acceptance Criteria**: The file [engine.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/policy/engine.ts) exists, and all unit tests in [src/lib/policy/engine.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/policy/engine.test.ts) pass successfully.
...
* **Repository Artifact**: [src/lib/decision/simulate.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/decision/simulate.ts) & [src/app/api/policy/simulate/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/policy/simulate/route.ts)
* **Acceptance Criteria**: The simulation API endpoint returns a 200 comparison payload indicating `current → proposed` outcomes, and simulation tests in [src/lib/decision/simulate.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/decision/simulate.test.ts) pass.
...
* **Repository Artifact**: [src/lib/audit/hash-chain.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/audit/hash-chain.ts)
* **Acceptance Criteria**: `verifyHashChain` utility correctly detects log mutations and returns detailed structural failure reasons; tests in [src/lib/audit/hash-chain.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/audit/hash-chain.test.ts) pass.
...
* **Repository Artifact**: [src/lib/security/analyzer.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/analyzer.ts)
* **Acceptance Criteria**: The risk analysis function computes score thresholds correctly, and unit tests in [src/lib/security/analyzer.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/analyzer.test.ts) pass.
...
* **Repository Artifact**: [src/lib/auth/wallet-challenge.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/auth/wallet-challenge.ts)
* **Acceptance Criteria**: Challenge generation, signing verification, and authentication state resolve successfully; tests in [src/lib/auth/wallet-challenge.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/auth/wallet-challenge.test.ts) pass.
...
* **Repository Artifact**: [src/lib/storage/db.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/storage/db.ts)
* **Acceptance Criteria**: Persistent operations fail-over gracefully to local store JSON files on database timeout or connection error; tests in [src/lib/storage/db.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/storage/db.test.ts) pass.
...
* **Repository Artifact**: [src/app/api/metrics/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/metrics/route.ts) & [src/lib/observability/metrics.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/observability/metrics.ts)
* **Acceptance Criteria**: Querying `/api/metrics?format=prometheus` returns metrics in scrape-compatible format, and unit tests in [src/lib/observability/metrics.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/observability/metrics.test.ts) pass.
...
* **Repository Artifact**: [src/app/api/audit/export/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/audit/export/route.ts)
* **Acceptance Criteria**: Export route returns correctly filtered records based on scopes, and tests in [src/app/api/audit/export/route.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/audit/export/route.test.ts) pass.
...
* **Repository Artifact**: [src/lib/auth/require-auth.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/auth/require-auth.ts) & [src/lib/auth/session.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/auth/session.ts)
* **Acceptance Criteria**: Access control blocks unauthorized actions and enforces role scopes; tests in [src/lib/auth/session.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/auth/session.test.ts) pass.
...
* **Repository Artifact**: [src/app/api/stellar/submit-signed/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/stellar/submit-signed/route.ts)
* **Acceptance Criteria**: The endpoint caches submit results and returns 409 conflicts on mismatched payloads; tests in [src/app/api/stellar/submit-signed/route.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/stellar/submit-signed/route.test.ts) pass.
...
* **Repository Artifact**: [src/lib/security/blocklist.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/blocklist.ts)
* **Acceptance Criteria**: The blocklist checker correctly caches URLs for 5 minutes and flags blocked domains; tests in [src/lib/security/blocklist.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/blocklist.test.ts) pass.
...
* **Repository Artifact**: [src/lib/stellar/verify-payment-quote.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/stellar/verify-payment-quote.ts)
* **Acceptance Criteria**: Transaction destination, amount, memo, and network are verified, rejecting any parameter shifts; tests in [src/lib/stellar/verify-payment-quote.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/stellar/verify-payment-quote.test.ts) pass.
...
* **Repository Artifact**: [src/lib/security/shared-security-state.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/shared-security-state.ts)
* **Acceptance Criteria**: Rate limit locks are updated in shared state, and tests in [src/lib/security/rate-limit.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/rate-limit.test.ts) and [src/lib/security/shared-security-state.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/security/shared-security-state.test.ts) pass.
...
* **Repository Artifact**: [src/lib/stellar/client.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/stellar/client.ts) & [src/app/api/stellar/build-payment/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/stellar/build-payment/route.ts)
* **Acceptance Criteria**: Built XDR is compiled and submitted successfully using the Stellar SDK library; tests in [src/app/api/stellar/build-payment/route.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/stellar/build-payment/route.test.ts) pass.
...
* **Repository Artifact**: [src/app/api/agent/plan/route.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/app/api/agent/plan/route.ts)
* **Acceptance Criteria**: Endpoint handles prompts and evaluates actions, and scenario tests in [src/lib/decision/engine.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/decision/engine.test.ts) pass successfully.
...
* **Repository Artifact**: [src/lib/storage/migrations.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/storage/migrations.ts) & [scripts/run-db-migrations.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/scripts/run-db-migrations.ts)
...
* **Repository Artifact**: [scripts/reset-local-demo-state.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/scripts/reset-local-demo-state.ts)
* **Acceptance Criteria**: The script safely resets local files/tables when all guardrails are met, and unit tests in [src/lib/storage/reset-local-demo-state.test.ts](file:///c:/Users/ICT%20LASIEC/NexusGuard/src/lib/storage/reset-local-demo-state.test.ts) pass.
...
* **Repository Artifact**: [docs/observability.md](file:///c:/Users/ICT%20LASIEC/NexusGuard/docs/observability.md) & [docs/grafana](file:///c:/Users/ICT%20LASIEC/NexusGuard/docs/grafana)
